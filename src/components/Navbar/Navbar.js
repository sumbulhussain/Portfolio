...
const Navbar = () => {
  ...
  return (
    <StyledNavbar className={stickyNav ? "sticky" : ""}>
      <div>
        <NavLogo to="https://github.com/sumbulhussain" onClick={toTop} src={logo} alt="logo" style={{backgroundColor:"white", width: "10", height:"10"}}  />
      </div>
      <NavMenuList>
        <NavList>
          <StyledNavLinks
      ...
      <StyledCTA
        href="mailto:sumbulhussain000@gamil.com "
        target="_blank"
        rel="noreferrer"
      >
        <span>
